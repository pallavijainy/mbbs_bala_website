    ...
    return (
        <div className="flex flex-col gap-10 lg:flex-row items-center justify-between px-5 py-12 lg:px-16 md:px-8 bg-white">
            <div className="lg:w-1/2 text-center lg:text-left space-y-5">
                ...
                <h2 className="text-3xl font-bold "> <span  className="text-blue-500">Connect</span> with Our Community</h2>
                <p className="text-gray-700 text-justify ">
                    Stay ahead in the digital realm – subscribe to our newsletter for exclusive insights,
                    latest updates, and innovative trends in SAAS solutions.
                </p>
                <p className="text-gray-700 text-justify">
