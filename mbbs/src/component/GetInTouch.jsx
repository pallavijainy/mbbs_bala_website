    ...
    <section className="py-12 px-5 md:px-8 lg:px-16">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
        <div className="text-center lg:text-left">
          <h2 className="text-2xl md:text-7xl font-bold lg:mb-10">Get in touch</h2>
          <p className="text-gray-600 mb-6 lg:text-2xl">Our friendly team would love to hear from you!</p>

          <div className="flex items-center gap-4 mb-4 lg:mb-20 lg:mt-10">
            <div>
          ...
          <div className="space-y-10 lg:mt-20">
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-[#808080] text-sm lg:text-lg">Sf 17, Aakriti Business Centre, Salaiya, Bhopal, (MP), 462026</p>
            </div>
          </div>
        </div>
        <div className="flex justify-center lg:justify-end">
          <div className="bg-white rounded-lg p-4 w-full">
            <div className="">
              <img src={Contact} alt="Counselor" className="" />
            </div>
          </div>
        </div>
      </div>
