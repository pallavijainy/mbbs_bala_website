...
<div className="flex justify-start items-center text-3xl gap-6">
      <div
        className="flex justify-center items-center w-32 h-32 md:w-20 md:h-30 rounded-full shadow-lg object-cover"
      ...
      <h1 className="text-7xl font-bold">Pathway</h1>
    </div>
    <div className="flex justify-start items-center text-3xl gap-6">
      <div
        className="flex justify-center items-center w-32 h-32 md:w-20 md:h-30 rounded-full shadow-lg object-cover"
      ...
      <h1 className="text-7xl font-bold">Seamless</h1>
    </div>
    <div className="flex justify-start items-center text-3xl gap-6">
      <div
        className="flex justify-center items-center w-32 h-32 md:w-20 md:h-30 rounded-full shadow-lg object-cover"
      ...
      <h1 className="text-7xl font-bold">Admission</h1>
    </div>
    <div className="flex justify-start items-center text-3xl gap-6">
      <div
        className="flex justify-center items-center w-32 h-32 md:w-20 md:h-30 rounded-full shadow-lg object-cover"
      ...
      <h1 className="text-7xl font-bold">Assistance</h1>
    </div>
    </div>
